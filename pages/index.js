...
export default function Home() {
  ...
  return (
    <div className={theme?'dark:':''}>
      ...
      <main className=' bg-gray-300 px-10 md:px-20 lg:px-40 dark:bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black overflow-hidden'>
        ...
        <section className='min-h-screen'>
          ...
          <div className=' relative mx-auto bg-gradient-to-b from-teal-500 rounded-full w-60 h-60 sm:w-80 sm:h-80 mt-10 overflow-hidden'>
            <Image src={deved} alt="A description of the image" layout='fill' objectFit='cover'/>
          </div>
           ...
           <section>
              ...
              <div className=' flex flex-col items-center text-center  p-10 rounded-10 mb-10 border border-gray-200 rounded-lg shadow-2xl'>
                <Image class="im1" alt='a' src={design} width={100} />
              ...
              <div className=' flex flex-col items-center text-center  p-10 rounded-10 mb-10 border border-gray-200 rounded-lg shadow-2xl'>
                <Image class="im2" alt='a' src={consulting} width={100} />
              ...
              <div className=' flex flex-col items-center text-center  p-5 rounded-10 mb-10 border border-gray-200 rounded-lg shadow-2xl'>
                <Image class="im5"  alt='a' src={discord} width={100} />
              ...
              <div className=' flex flex-col items-center text-center  p-5 rounded-10 mb-10 border border-gray-200 rounded-lg shadow-2xl'>
                <Image class="im6" alt='a' src={ui} width={100} />
      ...
      {/* <section>
          <div className=' bg-black h-10 w-screen flex justify-center items-center'>
            <p>
